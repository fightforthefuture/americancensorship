...
displayAmericanCensorshipModal = function() {
  ...
  if (!global_displayAmericanCensorshipModal) {
      ...
      var css = '#signupmodal-overlay{display:block;position:fixed;top:0;left:0;width:100%;height:100%;background-color:#444;z-index:1001;-moz-opacity:.8;opacity:.8;filter:alpha(opacity=80);}#signupmodal-lightbox{display:block;position:relative;width:600px;height:95%;max-height:900px;padding:0;margin-top:1%;margin-bottom:1%;margin-left:auto;margin-right:auto;background-color:#fff;z-index:1500;overflow:scroll;box-shadow:0px 0px 25px #171717;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;overflow:hidden;}#signupmodal-lightbox iframe{border:0;margin:0;padding:0;width:100%;height:100%;overflow:scroll;}#signupmodal-close{color:white;font-family:"Helvetica","Arial",sans-serif;float:right;vertical-align:10px;z-index:100;position:absolute;margin-left:552px;vertical-align:50px;}#signupmodal-container{position:fixed;top:0;left:0;width:100%;height:100%;}';
      ...
      var html = '<a id="signupmodal-overlay" href="javascript:void(0)" onclick="javascript:document.getElementById(\'signupmodal-overlay\').style.display=\'none\';document.getElementById(\'signupmodal-lightbox\').style.display=\'none\';"></a>'
               ...
               + '</a>'
               + '<iframe src="http://americancensorship.org/modal/email-congress/index.html"></iframe>'
               + '</div>'
               + '</div>';
